...
const PublishForm = () => {
    ...
    const publishBlog = (e) => {
        ...
        if(!title.length){
            return toast.error("Write blog title before editing")
        }
    ...
    return(
        <AnimationWrapper>
            <section className="w-screen min-h-screen grid items-center lg:grid-cols-2 py-2 lg:gap-4">
                ...
                <div className="boarder-grey lg:border-1 lg:pl-8">
                    ...
                    <p className="text-dark-grey mb-2 mt-9">Short description about your block</p>
                    ...
                    <p className="mt-1 mb-1 text-dark-grey text-right">{ tagLimit - tags.length } Tags Left</p>
