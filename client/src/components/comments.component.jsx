...
/*
    Comments come back as a flat array rather than a tree — each entry carries a
    childrenLevel used for indentation. That keeps "load more" and inserting a new
    reply cheap, since nothing has to be re-nested.
*/
