...
const SideNav = () => {
    ...
    const [pageState, setPageState] = useState(page ? page.replace("-", " ") : "");
    ...
    const changePageState = (e) => {
        ...
        // Tapping the current page name on mobile is what opens the drawer.
        setShowSideNav(e.target === sideBarIconTab.current);
    };
